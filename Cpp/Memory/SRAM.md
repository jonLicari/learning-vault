...
- DRAM does not retain charge over time and thus, must frequently refresh capacitors to retain data

Advantages:
- Since SRAM retains data without the need for refreshing it is faster than DRAM 
- SRAM consumes less power than DRAM

Disadvantages
- Physically takes up more space than DRAM (less memory per chip)
